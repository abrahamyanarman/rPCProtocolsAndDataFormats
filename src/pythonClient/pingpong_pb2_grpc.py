...
class PingPongServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.SendPing = channel.unary_unary(
                '/am.train.rpc.protocols.stubs.PingPongService/SendPing',
...
def add_PingPongServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'am.train.rpc.protocols.stubs.PingPongService', rpc_method_handlers)
...
class PingPongService(object):
    ...
    def SendPing(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/am.train.rpc.protocols.stubs.PingPongService/SendPing',
